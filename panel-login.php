...
<title>Admin Login ΓÇô TronSick</title>
...
<div class="auth-page">
  ...
  <div class="auth-left">
    ...
    <p class="al-p">Full control over your platform ΓÇö manage users, payouts, games, faucet settings, and more from one place.</p>
    <div class="al-perks">
      <div class="al-perk"><span class="al-ck">Γ£ô</span><span>Manage <strong>Faucet & Bonus</strong> settings</span></div>
      <div class="al-perk"><span class="al-ck">Γ£ô</span><span>Control <strong>Games & Win Rates</strong></span></div>
      <div class="al-perk"><span class="al-ck">Γ£ô</span><span>Handle <strong>Withdrawals & Deposits</strong></span></div>
      <div class="al-perk"><span class="al-ck">Γ£ô</span><span>Configure <strong>OxaPay Gateway</strong></span></div>
      <div class="al-perk"><span class="al-ck">Γ£ô</span><span>Manage <strong>Users & Security</strong></span></div>
    </div>
    <div class="al-stats">
      <div class="al-stat"><strong id="slUsers">ΓÇö</strong><span>Total Users</span></div>
      <div class="al-stat"><strong id="slWithdraws">ΓÇö</strong><span>Withdrawals</span></div>
      <div class="al-stat"><strong id="slBalance">ΓÇö</strong><span>Site Balance</span></div>
    </div>
  </div>
  ...
  <div class="auth-right">
    <div class="ar-topbar">
      ...
      <a href="/faucet.php">ΓåÉ Back to Site</a>
    </div>
    <div class="ar-body">
      <div class="ar-card">
        <div class="al-icon-wrap"><i class="fas fa-lock"></i></div>
        <h2>Administrator Login</h2>
        <p class="ar-switch">Restricted access ΓÇö authorized personnel only</p>
        ...
        <form onsubmit="doAdminLogin(event)" id="loginForm">
          ...
          <div class="ff">
            ...
            <div class="ff-iw">
              ...
              <button type="button" class="ff-eye" onclick="toggleVis('apPw',this)">≡ƒæü</button>
            </div>
          </div>
          ...
          <p class="auth-note">≡ƒöÆ All admin actions are logged and monitored ┬╖ <a href="/faucet.php">Return to site ΓåÆ</a></p>
        </form>
      </div>
    </div>
  </div>
...
function toggleVis(id, btn) {
  ...
  btn.textContent = i.type === 'password' ? '≡ƒæü' : '≡ƒÖê';
}
...
function doAdminLogin(e) {
  ...
  if (user === ADMIN_USER && pw === ADMIN_PASS) {
    ...
    btn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Logging inΓÇª';
    btn.disabled = true;
