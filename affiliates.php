...
<main class="main">
  ...
  <!-- AFFILIATES -->
  <div class="pg active" id="sec-affiliates">
    <div class="aff-wrap">
      ...
      <div class="aff-rewards-box" style="margin-top:16px">
        ...
        <div style="margin-top:10px;font-size:11px;color:rgba(232,240,235,.3);text-align:center">&#128994; Live data &ndash; Auto-refreshes every 5s</div>
      </div>
  </div>
  <!-- STAKE -->
