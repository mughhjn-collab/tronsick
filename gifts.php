...
<head>
  ...
  <title>Gift Cards &ndash; TronSick</title>
...
<aside class="sidebar" id="sidebar">
  ...
  <!-- Nav items -->
  <nav class="sb-nav">
    <a class="sb-item active" id="nav-home"       onclick="go('home')">      <i>&#x1F3E0;</i><s>Home</s></a>
    <a class="sb-item"        id="nav-games"       onclick="go('games')">     <i>&#x1F3AE;</i><s>Games</s></a>
    <a class="sb-item"        id="nav-deposit"     onclick="go('deposit')">   <i>&#x1F4B0;</i><s>Deposit</s></a>
    <a class="sb-item"        id="nav-withdraw"    onclick="go('withdraw')">  <i>&#x1F3E6;</i><s>Withdraw</s></a>
    <a class="sb-item"        id="nav-cashback"    onclick="go('cashback')">  <i>&#x1F4B5;</i><s>Cashback</s></a>
    <a class="sb-item"        id="nav-contest"     onclick="go('contest')">   <i>&#x1F3C6;</i><s>Contest</s></a>
    <a class="sb-item"        id="nav-surveys"     onclick="go('surveys')">   <i>&#x1F4CB;</i><s>Surveys</s></a>
    <a class="sb-item"        id="nav-affiliates"  onclick="go('affiliates')"><i>&#x1F91D;</i><s>Affiliates</s></a>
    <a class="sb-item"        id="nav-gifts"       onclick="go('gifts')">     <i>&#x1F381;</i><s>Gifts</s></a>
...
<header class="topbar">
  ...
  <button class="tb-wallet" onclick="go('withdraw')">WALLET</button>
</header>
...
<main class="main">
  ...
  <footer class="foot">
    <div class="foot-in">
      ...
      <div class="fc"><h4>Account</h4><a onclick="go('settings')">Settings</a><a onclick="go('withdraw')">Withdraw</a><a onclick="go('deposit')">Deposit</a></div>
      <div class="fc"><h4>Earn TRX</h4><a onclick="go('home')">Faucet</a><a onclick="go('games')">Games</a><a onclick="go('affiliates')">Referrals</a></div>
      <div class="fc"><h4>Help</h4><a onclick="go('contact')">Contact</a><a href="#">FAQ</a><a href="#">Privacy</a><a href="#">Terms</a></div>
    </div>
